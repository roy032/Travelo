    ...
    <div>
      <div className="mb-4">
        ...
        <p className="text-gray-600 mt-1">
          {mapData.activities.length} {mapData.activities.length === 1 ? 'location' : 'locations'} on map
        </p>
      </div>
      ...
      {/* Activity List */}
      <div className="mt-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Activities on Map</h3>
        <div className="space-y-2">
          {mapData.activities.map((activity) => (
            ...
            >
              <MapPin size={20} className="text-blue-600 mr-3 mt-0.5 shrink-0" />
