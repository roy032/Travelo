...
const SplitSummary = ({ tripId, refreshKey = 0 }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Expense Split Summary</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-purple-900">Members</span>
            </div>
          ...
          <div className="bg-green-50 rounded-lg p-4 border border-green-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-green-900">Equal Share</span>
            </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Member Breakdown</h3>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{split.user.name}</p>
                    <p className="text-sm text-gray-500">{split.user.email}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  {getBalanceIcon(split.netBalance)}
                  <span className={`font-semibold ${getBalanceColor(split.netBalance)}`}>
              ...
              <div className="grid grid-cols-3 gap-4 pt-3 border-t border-gray-100">
                ...
                <div>
                  ...
                  <p className={`text-sm font-semibold ${getBalanceColor(split.netBalance)}`}>
